...
export default async function ProductDetailPage({ params }: ProductPageProps) {
  ...
  return (
    <>
      ...
      {relatedProducts.length > 0 && <section className="bg-[#fde9e7]"><div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-20"><SectionHeading eyebrow="Related products" title="More from this filter family" /><div className="mt-9 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">{relatedProducts.map((related) => <ProductCard key={related.id} product={related} />)}</div></div></section>}
