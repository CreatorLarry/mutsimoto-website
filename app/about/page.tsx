...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <section className="dark-panel px-5 py-8 text-white sm:px-8 lg:px-10"><div className="blueprint-grid-dark mx-auto grid max-w-7xl gap-3 rounded-[30px] border-t-4 border-[#e52833] bg-[linear-gradient(120deg,#07172b,#123446)] p-4 sm:p-6 md:grid-cols-2 lg:grid-cols-3">{[
